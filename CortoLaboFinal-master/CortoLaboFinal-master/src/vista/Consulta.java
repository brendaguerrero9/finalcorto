...
public class Consulta extends JFrame {
    ...
    private void llenarTabla() {
        ...
        for (Filtro fi : filtros) {
            ...
            tm.addRow(new Object[]{fi.getCarnet(), fi.getNombre(), fi.getApellidos(),fi.getUniversidad(), fi.getEstado()});
        }
    ...
    private void eventos() {
        insertar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                FiltroDao fd = new FiltroDao();
                Filtro f = new Filtro(carnet.getText(), nombre.getText(), apellidos.getText(), Integer.parseInt(edad.getText()), universidad.getSelectedItem().toString(), true);
                ...
                if (fd.create(f)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un problema con la creación de este alumno.");
                }
            }
        });
        ...
        actualizar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.update(f)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un problema al momento de modificar de este alumno.");
                }
            }
        });
        ...
        eliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.delete(carnet.getText())) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un problema al momento de eliminar este alumno.");
                }
            }
        });
        ...
        buscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (f == null) {
                    JOptionPane.showMessageDialog(null, "El alumno buscado no ha sido encontrado");
                } else {
